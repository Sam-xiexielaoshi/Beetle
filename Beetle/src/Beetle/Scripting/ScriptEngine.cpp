...
namespace Beetle
{
	...
	void ScriptEngine::Init()
	{
		...
		s_Data->EntityClass = ScriptClass("Beetle", "Entity", true);
		LoadAssemblyClasses();
	...
	void ScriptEngine::LoadAssemblyClasses()
	{
		...
		int32_t numTypes = mono_table_info_get_rows(typeDefinitionsTable);
		MonoClass* entityClass = mono_class_from_name(s_Data->CoreAssemblyImage, "Beetle", "Entity");
