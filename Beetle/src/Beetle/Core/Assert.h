...
#define BT_INTERNAL_ASSERT_NO_MSG(type, check) BT_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", BT_STRINGIFY_MACRO(check), ::Beetle::Assert::CurrentFileName(__FILE__), __LINE__)
