...
#define BIND_EVENT_FN(x) std::bind(&x, this, std::placeholders::_1)
	...
	static GLenum ShaderDataTypeToOpenGLBaseType(ShaderDataType type)
	{
		...
		case Beetle::ShaderDataType::Float: return GL_FLOAT;
			...
			case Beetle::ShaderDataType::Mat4: return GL_FLOAT;
			case Beetle::ShaderDataType::Int: return GL_INT;
			case Beetle::ShaderDataType::Int2: return GL_INT;
			case Beetle::ShaderDataType::Int3: return GL_INT;
			case Beetle::ShaderDataType::Int4: return GL_INT;
			case Beetle::ShaderDataType::Bool: return GL_BOOL;
		}
