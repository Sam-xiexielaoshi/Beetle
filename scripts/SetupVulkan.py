...
class VulkanConfiguration:
    ...
    vulkanDirectory = "./Beetle/vendor/VulkanSDK"

    @classmethod
    def _GetVulkanSDKEnv(cls):
        ...
        if vulkanSDK:
            os.environ["VULKAN_SDK"] = vulkanSDK
            return vulkanSDK

        vulkanSDK = Utils.GetUserEnvironmentVariable("VULKAN_SDK")
        if vulkanSDK:
            os.environ["VULKAN_SDK"] = vulkanSDK
            return vulkanSDK
    ...
    def CheckVulkanSDK(cls):
        vulkanSDK = cls._GetVulkanSDKEnv()
        ...
        if (cls.requiredVulkanVersion not in vulkanSDK):
            print(f"You don't have the correct Vulkan SDK version! (Beetle requires {cls.requiredVulkanVersion})")
            cls.__InstallVulkanSDK()
            return False
